...
def test_task1_2_simple() -> None:
    ...
    assert len(
        history[0].incoming_calls) == 1, """Should only be one history object"""
...
def test_task1_2_with_diff_month() -> None:
    ...
    assert len(history[
                   0].outgoing_calls) == 3, """222-2222 made calls in 3 diff months"""
    all_records = history[0].get_monthly_history()
...
def test_task1_2_with_all() -> None:
    ...
    history = []
    expect = [(27, 26), (13, 11), (39, 36), (18, 16), (3, 8), (42, 31),
              (25, 23), (16, 19), (37, 40), (27, 28), (7, 12), (19, 14),
              (29, 17), (27, 19), (31, 29), (4, 2), (10, 19), (15, 12), (3, 6),
              (10, 10), (4, 2), (3, 5), (20, 22), (22, 20), (22, 37), (30, 25),
              (27, 26), (16, 19), (30, 45), (19, 29), (8, 7), (44, 21),
              (16, 23), (37, 33), (15, 18), (28, 33), (4, 4), (30, 24),
              (21, 25), (28, 32), (25, 20), (13, 14), (13, 18), (25, 22),
              (7, 10), (21, 23), (26, 33), (11, 11), (12, 10), (21, 11)]
    for customer in customers:
        v = customer.get_history()
        history.append((len(v[0]), len(v[1])))
    for i in range(len(history)):
        assert history[i] == expect[
            i], "Outgoing and incoming total for customer " + str(
            customer.get_id()) + " is wrong"


def gen_call(duration: int) -> Call:
    return Call("shit", "fuck", datetime.date(2000, 2, 2), duration, [1, 1],
                [1, 1])


# come back and test this one
def test_task3_term() -> None:
    ...
    contract.new_month(1, 2017, Bill())
    contract.new_month(2, 2017, Bill())
    assert contract.cancel_contract() == pytest.approx(20)
...
def test_task4() -> None:
    ...
    for i in range(len(filters)):
        for j in range(len(filter_strings[i])):
            ...
            assert len(result) == expected_return_lengths[i][j], str(
                filters[i].__class__.__name__) + ", with keyword " + \
                                                                 filter_strings[
                                                                     i][
                                                                     j] + " produce wrong result"
